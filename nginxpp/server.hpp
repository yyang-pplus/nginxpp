...
[[nodiscard]] ServerOptions
HandleServerOptions(const cxxopts::ParseResult &parsed_options) noexcept;
...
[[nodiscard]] Socket createServerSocket(const ServerOptions &options);
